...
apt -y update
apt -y upgrade
apt -y install exfat-fuse python3 libncurses5 fte-terminal libxext-dev libncurses5-dev libx11-dev libxpm-dev libxrandr-dev libgbm1 libgl1-mesa-dri libegl1-mesa libinput10 kmscube
